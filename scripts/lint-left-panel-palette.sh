...
TARGETS=(
  "frontend/src/components/Investigation/Verdict.tsx"
  "frontend/src/components/Investigation/StatusStrip.tsx"
  "frontend/src/components/Investigation/InvestigationLog.tsx"
)
