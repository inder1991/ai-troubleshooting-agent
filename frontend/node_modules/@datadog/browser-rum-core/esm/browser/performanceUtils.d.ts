...
export declare function getNavigationEntry(): RumPerformanceNavigationTiming;
export type TimingsFromDeprecatedPerformanceTiming = {
    -readonly [key in keyof Omit<PerformanceTiming, 'toJSON'>]: RelativeTime;
};
export declare function computeTimingsFromDeprecatedPerformanceTiming(): TimingsFromDeprecatedPerformanceTiming;
