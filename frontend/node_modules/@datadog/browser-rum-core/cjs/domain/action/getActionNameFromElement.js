...
function getActionNameFromStandardAttribute(element, attribute, rumConfiguration, nodePrivacyLevelCache) {
    ...
    if (attributeValue && enablePrivacyForActionName) {
        const nodePrivacyLevel = (0, privacy_1.getNodePrivacyLevel)(element, defaultPrivacyLevel, nodePrivacyLevelCache);
        if ((0, privacy_1.shouldMaskAttribute)(element.tagName, attribute, attributeValue, nodePrivacyLevel, rumConfiguration)) {
            attributeValue = (0, privacy_1.maskDisallowedTextContent)(attributeValue, actionNameConstants_1.ACTION_NAME_PLACEHOLDER);
        }
    }
