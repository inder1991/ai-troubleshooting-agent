...
const AttestationGateUI: React.FC<AttestationGateUIProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="bg-[#1a1814] border border-[#3d3528] rounded-xl shadow-2xl w-full max-w-lg mx-4">
        {/* Header */}
        <div className="px-6 py-4 border-b border-[#3d3528] flex items-center justify-between">
        ...
        <div className="px-6 py-4 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          <div>
            <button
              ...
              className="flex items-center gap-2 text-sm text-[#e09f3e] hover:text-[#38d9f5] transition-colors"
            >
            ...
            {evidenceExpanded && (
              <ul className="mt-2 space-y-1.5 pl-4">
                {evidencePins.map((pin, idx) => (
                  <li
                    key={idx}
                    className="text-xs text-gray-400 bg-[#252118]/50 border border-[#3d3528] rounded px-3 py-2"
                  >
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full bg-[#252118] border border-[#3d3528] rounded-lg px-3 py-2 text-sm text-white placeholder-gray-600 resize-none focus:outline-none focus:ring-1 focus:ring-[#e09f3e]"
        ...
        {/* Actions */}
        <div className="px-6 py-4 border-t border-[#3d3528] flex gap-3 justify-end">
          <button
