    ...
    <div className="border border-slate-800 rounded bg-slate-950/40 p-4 space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-body-xs font-bold text-blue-400 uppercase tracking-widest">
            Validation Details
          </span>
        </div>
        <div className={`text-body-xs font-bold ${data.passed ? 'text-emerald-400' : 'text-red-400'}`}>
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-body-xs font-mono text-slate-400">Linting Check</span>
        </div>
        ...
        {data.linting.issues.warnings && data.linting.issues.warnings.length > 0 && (
          <div className="ml-5 pl-3 border-l-2 border-yellow-500/30 space-y-1">
            ...
            {data.linting.issues.warnings.slice(0, 2).map((warning: any, idx: number) => (
              <div key={idx} className="text-chrome text-yellow-400 bg-yellow-950/20 border border-yellow-900/30 rounded p-2">
      ...
      <div className="space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-body-xs font-mono text-slate-400">Import Validation</span>
        </div>
        ...
        <div className="pt-3 border-t border-slate-800 space-y-2">
          ...
          {typeof data.agent2_confidence !== 'undefined' && (
            <div className="ml-5 flex items-center gap-2">
              ...
              <span className="text-chrome font-bold text-slate-400">
