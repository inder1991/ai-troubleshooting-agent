...
const ASGNode: React.FC<NodeProps<ASGNodeData>> = ({ data, selected }) => {
  ...
  return (
    <div className="relative w-full h-full rounded-lg border-2 border-dashed group"
         style={{ backgroundColor: 'rgba(16,185,129,0.05)', borderColor: selected ? '#10b981' : '#065f46', pointerEvents: 'none' }}>
      ...
      <NodeResizeControl minWidth={250} minHeight={160}
        style={{ background: '#10b981', width: '8px', height: '8px', borderRadius: '2px', pointerEvents: 'auto' }}
      />
      ...
      <div className="container-interactive absolute bottom-2 left-3 text-[10px] font-mono" style={{ color: '#64748b' }}>
