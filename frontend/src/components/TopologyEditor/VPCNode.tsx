...
const VPCNode: React.FC<NodeProps<VPCNodeData>> = ({ data, selected }) => {
  return (
    <div className="relative w-full h-full rounded-lg border-2 border-dashed group"
         style={{ backgroundColor: 'rgba(59,130,246,0.05)', borderColor: selected ? '#3b82f6' : '#1e3a5f', pointerEvents: 'none' }}>
      ...
      <NodeResizeControl minWidth={300} minHeight={200}
        style={{ background: '#3b82f6', width: '8px', height: '8px', borderRadius: '2px', pointerEvents: 'auto' }}
      />
