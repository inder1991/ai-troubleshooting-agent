...
const VSCodeLink: React.FC<VSCodeLinkProps> = ({ filePath, repoName, line }) => {
  ...
  return (
    <a
      href={href}
      className="inline-flex items-center gap-1.5 px-2 py-1 rounded bg-wr-surface/60 border border-wr-border-strong hover:bg-wr-inset transition-colors text-body-xs text-cyan-400 font-mono"
    >
