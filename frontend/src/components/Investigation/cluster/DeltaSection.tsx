  ...
  return (
    <div className="space-y-2 px-3 py-2">
      {delta.new_risks.length > 0 && (
        <div>
          <span className="text-body-xs uppercase tracking-wider text-emerald-400 font-semibold">+ New</span>
          <div className="mt-1 space-y-0.5">
            {delta.new_risks.map((r, i) => (
              <div key={i} className="text-body-xs text-emerald-300/80 flex items-center gap-1">
      ...
      {delta.worsened.length > 0 && (
        <div>
          <span className="text-body-xs uppercase tracking-wider text-red-400 font-semibold">Worsened</span>
          <div className="mt-1 space-y-0.5">
            {delta.worsened.map((r, i) => (
              <div key={i} className="text-body-xs text-red-400 flex items-center gap-1">
      ...
      {delta.improved.length > 0 && (
        <div>
          <span className="text-body-xs uppercase tracking-wider text-emerald-400 font-semibold">Improved</span>
          <div className="mt-1 space-y-0.5">
