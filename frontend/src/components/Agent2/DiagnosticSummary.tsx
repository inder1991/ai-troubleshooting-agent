    ...
    <div className="space-y-6 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <button
            ...
            className="text-body-xs text-slate-400 hover:text-white transition"
        >
            ⛶ Expand
        </button>
        </div>
        ...
        <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-body-xs font-bold text-red-400 uppercase tracking-widest">Blast Radius Analysis</span>
          </div>
          <div className="prose-invert text-body-xs leading-relaxed text-slate-300 custom-markdown">
      ...
      <div className="border border-emerald-500/30 rounded-lg bg-slate-950 overflow-hidden shadow-2xl shadow-emerald-500/5">
        <div className="p-3 bg-emerald-500/5 border-b border-slate-900 flex justify-between items-center">
          ...
          <button 
            ...
            className="bg-emerald-600 hover:bg-emerald-500 text-white text-body-xs px-4 py-2 rounded-md font-bold transition-all flex items-center gap-2 shadow-lg shadow-emerald-900/20"
          >
            <GitPullRequest size={14} /> Stage Pull Request
          </button>
        </div>
        <div className="p-4 bg-slate-950 font-mono text-body-xs text-slate-300 overflow-x-auto custom-scrollbar border-t border-slate-900">
