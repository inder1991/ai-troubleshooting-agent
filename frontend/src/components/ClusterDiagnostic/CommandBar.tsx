...
const CommandBar: React.FC = () => {
  ...
  return (
    <footer className="h-12 bg-wr-surface border-t border-wr-border sticky bottom-0 z-50 flex items-center px-4 shrink-0">
      <div className="flex items-center gap-3 w-full max-w-4xl mx-auto">
        <span className="text-wr-accent font-mono text-sm font-bold">$</span>
        <input
