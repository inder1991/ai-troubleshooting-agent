...
const VerdictStack: React.FC<VerdictStackProps> = ({ events }) => {
  return (
    <div className="flex-1 overflow-hidden flex flex-col">
      <h3 className="text-body-xs uppercase font-bold tracking-widest text-slate-400 mb-4 px-2">Verdict Stack</h3>

      {events.length === 0 && (
        <p className="text-xs text-slate-500 animate-pulse px-4">Correlating events...</p>
      )}
