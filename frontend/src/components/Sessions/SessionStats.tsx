...
const SessionStats: React.FC<SessionStatsProps> = ({ sessions }) => {
  ...
  const stats = [
    { label: 'Total Sessions', value: total, icon: 'database', color: '#8a7e6b', bg: 'rgba(100,116,139,0.2)' },
    { label: 'Active', value: active, icon: 'monitoring', color: '#4ade80', bg: 'rgba(34,197,94,0.2)' },
    { label: 'Completed', value: completed, icon: 'check_circle', color: '#e09f3e', bg: 'rgba(224,159,62,0.2)' },
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      {stats.map((stat) => (
        <div
          ...
          style={{ backgroundColor: 'rgba(30,47,51,0.5)', borderColor: '#3d3528' }}
        >
          <div
